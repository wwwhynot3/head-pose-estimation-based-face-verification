...
import torchvision
import algorithm.hopenet.utils as utils
import algorithm.hopenet.hopenet as hopenet
...
def test_hopenet():
    ...
    saved_state_dict = torch.load('resources/model/hopenet.pkl', map_location=torch.device('cpu'))

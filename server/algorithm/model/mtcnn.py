...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True,  model_path='resources/model/onet.pt'):
        super().__init__()
...
class MTCNN(nn.Module):
    ...
    def __init__(
        ...
        pnet_path=None, rnet_path=None, onet_path=None,
        ...
        self.onet = ONet(model_path=onet_path)
    ...
    def quantize(self):
        ...
        self.onet = algorithm.model.quantize_model(self.onet)
        return self
